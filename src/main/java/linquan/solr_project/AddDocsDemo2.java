...
public class AddDocsDemo2 {
	public static final String SOLR_URL = "http://10.0.3.170:8983/solr/guzi";
	...
	public static void AddDocs() {
		...
		doc1.addField("id", 5012);
		doc1.addField("cmd", 0);
		doc1.addField("orderId", 592);
		doc1.addField("priority", 1);
		doc1.addField("startTimestamp", 1461081600);
		doc1.addField("endTimestamp", 1462031999);
		doc1.addField("timePreference", 1);
		doc1.addField("speedupControl", 1);
