...
public class SolrCloudTool {
	...
	public  synchronized CloudSolrClient getCloudSolrServer(final String zkHost) {
	...
	public void export(CloudSolrClient cloudSolrClient, SolrQuery query) {
	...
	public static void main(String[] args) throws IOException {
		...
		CloudSolrClient cloudSolrClient = solrCloudTest.getCloudSolrServer(zkHost);
